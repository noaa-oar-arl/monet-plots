...
class WindQuiverPlot(BasePlot):
    """Creates a wind quiver plot.

    This class creates a wind quiver plot on a map.
    """
    ...
    def plot(self, ws, wdir, gridobj, **kwargs):
        ...
        self.ax.quiver(lon[::15, ::15], lat[::15, ::15], u[::15, ::15], v[::15, ::15], **kwargs)
